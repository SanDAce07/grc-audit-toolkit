...
| `aging-report-analyzer.py` | Analyze AR aging and produce an audit workpaper | Python |

## Aging Report Analyzer
`aging-report-analyzer.py` reads AR aging data, classifies balances into aging buckets, highlights severe overdue exposure, and writes a formatted Excel workbook for audit review.
